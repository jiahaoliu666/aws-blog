...
async function retryDiscordNotification(notification) {
    try {
        // 重新獲取文章內容
        ...
        // 重試發送 Discord 通知
        return await discordService.sendNotification(notification.userId, 'ANNOUNCEMENT', // 這裡可能需要根據實際情況調整通知類型
        content.title, content.summary, content.link);
    }
    catch (error) {
